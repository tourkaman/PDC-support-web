...
.. glossary::
   ...
   node
     Nodes are component of a cluster and analogus to computer we use everyday. 
   ...
   prosessor
     ...
     analogus to the CPU(Central processing unit) in a personal computer.
   ...
   Time Allocation
     ...
     Time allocation contains information about the project and how much resources the project have been allocated. 
   ...
   Principal Investigator (PI)
     ...
     and usually the one that applied for the time allocation. All project related utilities is managed through SUPR. 
   ...
   core-hours
     Core hours(c) can be calculated with Node hours (n) you have requested on a particular system,
